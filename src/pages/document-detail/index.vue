      ...
      <button class="back point" @click="back">返回</button>
        <div>
            ...
            <div class="content">
                ...
                <div>
                   <div class="right">
                      <div style="width: 860px;height: 500px;margin:0 auto;position:relative;background:rgba(3,94,255,0.15);border-radius:2px;border:1px solid rgba(11,66,187,1);padding:30px 0;box-sizing:border-box;">
                        <div class="con_4" id="loopDiv" style="width:660px;height:440px;">
                          <div v-for="(item, index) in imgList" :key="index" style="width: 600px; height: 440px">
