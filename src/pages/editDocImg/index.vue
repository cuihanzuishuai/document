      ...
      <button class="back point" @click="back">返回</button>
        <div>
            ...
            <div class="content">
                ...
                <div>
                   <div class="right">
                       <div class="con_4" id="loopDiv" style="width:715px;height:500px;">
                        <div v-for="(item, index) in imgList" :key="index" style="width: 715px; height:500px">
                              <canvas style="width:357.5px;height:500px" ref="canvas" class="canvas" @mousedown="mouseDown(index,$event)" @mouseup="mouseUp(index,$event)"></canvas>
