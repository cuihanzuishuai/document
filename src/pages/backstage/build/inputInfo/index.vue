  ...
  <div class="stage">
    ...
    <div class="info">
      <div class="input">
        ...
        <div class="inputInfo">
          <span><span style="color: red;width: 35px; float: left;">*</span>身份号</span>
          <input type="text" v-model="sfh" />
        </div>
        <div class="inputInfo">
          <span><span style="color: red;width: 35px; float: left;">*</span>档案号</span>
          <input type="text" v-model="danganID" />
        </div>
        <div class="inputInfo">
          <span><span style="color: red;width: 20px; float: left;">*</span>建档时间</span>
          <!-- <input type="text" v-model="danganID"> -->
          <el-date-picker
            v-model="jiandangdate"
            type="date"
            format="yyyy-MM-dd"
...
export default {
  ...
  methods: {
    getPersonInfo() {
      this.$api.build
        ...
        .then(data => {
          ...
          this.zhisfh = data.身份号;
          this.zhiname = data.姓名;
    ...
    submit() {
      ...
      if (this.danganID == "" || this.danganID == null) {
        this.$message({
          message: "警告哦，请输入档案号",
          type: "warning"
        });
      ...
      if (this.jiandangdate == "" || this.jiandangdate == null) {
        this.$message({
          message: "警告哦，请输入建档时间",
          type: "warning"
        });
      ...
      this.$api.build
        ...
        .then(data => {
          ...
          // this.$router.back();
          // this.$router.push(
          //   "home/backstage/paper_info?sfh=" + this.sfh + "name=" + this.name
          // );
          // this.$router.push({path:'/uapbd/paraset/edit',query:{pk_refinfo:'test',value:'test1'}});
          this.$router.push({path:'/home/backstage/paper_info',query: { sfh: this.sfh, name: this.name }});
        });
    },
    reset() {
      this.danganID = "";
