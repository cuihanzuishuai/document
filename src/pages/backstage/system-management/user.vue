      ...
      <div class="right">
        <div class="content">
          ...
          >
            ...
            <el-table-column prop="姓名" label="真实姓名"></el-table-column>
            <el-table-column prop="身份号" label="身份号" width="90"></el-table-column>
            <el-table-column prop="职务名称" label="职务" width="120"></el-table-column>
            <el-table-column prop="角色名称" label="关联角色" width="110"></el-table-column>
            <el-table-column prop="权限范围" label="权限范围"></el-table-column>
            <el-table-column prop="手机号" label="联系方式" width="120"></el-table-column>
            <el-table-column prop="状态" label="启用状态">
    ...
    <div class="editUserModel" v-show="editmodel">
      <div>
        ...
        <div class="cont_1">
          <p>
            <span>真实姓名</span>
            <input type="text" disabled v-model="userinfo.name" />
          </p>
          <p>
            <span>所属部别</span>
            <input type="text" disabled v-model="userinfo.danwei" />
          </p>
          <p>
            <span>职位</span>
            <input type="text" disabled v-model="userinfo.zw" />
          </p>
          <p>
            <span>角色</span>
          ...
          <p>
            <span>用户名</span>
            <input type="text" v-model="userinfo.yhm" />
          </p>
          <p>
            <span>权限范围</span>
            <input type="text" v-model="userinfo.qxfw" />
          </p>
          <p>
            <span>请重置密码</span>
            <input type="text" v-model="userinfo.newPsd" />
          </p>
          <p>
            <span>手机号</span>
            <input type="text" v-model="userinfo.sjh" />
          </p>
          <p>
            <span>座机</span>
            <input type="text" v-model="userinfo.zj" />
          </p>
        </div>
        <div class="btn_opt">
...
export default {
  ...
  methods: {
    ...
    edit(info) {
      ...
      this.userinfo.js = info["角色代码"];
      this.userinfo.yhm = info["用户名"];
      this.userinfo.qxfw = info["权限范围"];
