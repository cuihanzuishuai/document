                                ...
                                <div class="person_info">
                                    ...
                                    <ul  class="list_info">
                                       <li><span>{{item['身份号'] ? item['身份号'] : '暂无'}}</span></li>
                                        ...
                                        <li style="width:80px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;"><span :title="item['部别']">{{item['部别'] ? item['部别'] : '暂无'}}</span></li>
                                        <li><span>{{item['出生时间'].split('T')[0] ? item['出生时间'].split('T')[0] : '暂无'}}</span></li>
                                        <li><span>{{item['入伍时间'].split('T')[0] ? item['入伍时间'].split('T')[0] : '暂无'}}</span></li>
                                        <li style="width:80px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;"><span :title="item['职务']">{{item['职务'] ? item['职务'] : '暂无'}}</span></li>
