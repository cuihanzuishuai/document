            ...
            <div class="list">
              <div v-for="(item, index) in list" :key="index" class="card">
                ...
                <div class="add_info">
                  ...
                  <span
                    style="background:none;color:#00feff;margin-left:20px"
                    @click="chakan(item)"
                  >查看</span>
...
export default {
  ...
  methods: {
    chakan() {
      this.$router.push("/home/service/scan_files");
    },
