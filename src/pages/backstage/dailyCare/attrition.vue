        ...
        <div class="bottom">
          ...
          <div class="con_2">
            <el-table :data="list" stripe>
              <el-table-column prop="ids" label="序号" width="100"></el-table-column>
              <el-table-column prop="身份号" label="身份号" width="100"></el-table-column>
              <el-table-column prop="姓名" label="姓名" width="100"></el-table-column>
              <el-table-column prop="部别" label="部别"  :show-overflow-tooltip='true'></el-table-column>
              <el-table-column prop="职务名称" label="职务"  :show-overflow-tooltip='true'></el-table-column>
              <el-table-column prop="减员原因" label="减员原因" width="150"></el-table-column>
