            ...
            <div class="top_condition">
              <div class="top_btn">
                ...
                <div class="search_btn" v-show="isShowsql">
                  <button class="search point" @click="conditionSearch2" @keyup.enter="conditionSearch2()">查询</button>
                    ...
                    <div class="detail_info">
                      ...
                      <div class="person_info">
                        ...
                        <ul class="list_info">
                          ...
                          <li style="width:80px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;">
